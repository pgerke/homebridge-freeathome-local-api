...
- [#111](https://github.com/pgerke/homebridge-freeathome-local-api/issues/111):
  Dependency Bump
...
- [#109](https://github.com/pgerke/homebridge-freeathome-local-api/issues/109):
  Migrated to managed SonarQube
...
- [#101](https://github.com/pgerke/homebridge-freeathome-local-api/issues/101):
  Dependency Bump
...
- [#99](https://github.com/pgerke/homebridge-freeathome-local-api/issues/99):
  Support special scenes: panic, all off, all blinds up, all blinds down.

## 1.11.5 - 01.06.2024

### Changed

- [#97](https://github.com/pgerke/homebridge-freeathome-local-api/issues/97):
  Dependency Bump
...
- [#95](https://github.com/pgerke/homebridge-freeathome-local-api/issues/95):
  Dependency Bump
...
- [#93](https://github.com/pgerke/homebridge-freeathome-local-api/issues/93):
  Dependency Bump and workflow update

## 1.11.2 - 20.02.2024

### Changed

- [#91](https://github.com/pgerke/homebridge-freeathome-local-api/issues/91):
  Extract the data point for the sensor from the pairing ID

## 1.11.1 - 27.01.2024

### Changed

- [#89](https://github.com/pgerke/homebridge-freeathome-local-api/issues/89):
  Dependency Bump
...
- [#79](https://github.com/pgerke/homebridge-freeathome-local-api/issues/79):
  Dependency Bump and Migration to Homebridge 1.7.0

## 1.8.0 - 22.09.2023

### Changed

- [#76](https://github.com/pgerke/homebridge-freeathome-local-api/issues/76):
  Migrate to free@home local API client v1.4.0 to support SysAP data model extensions
...
- [#71](https://github.com/pgerke/homebridge-freeathome-local-api/issues/71):
  Dependency Bump and Migration to Prettier v3
