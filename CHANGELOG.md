...
## [1.19.0](https://github.com/pgerke/homebridge-freeathome-local-api/releases/tag/1.19.0) - 10.01.2026
...
- [#196](https://github.com/pgerke/homebridge-freeathome-local-api/issues/196): Fixed pairing ID for SmartTouch 10" Panel door call
